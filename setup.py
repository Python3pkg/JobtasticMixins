...
setup(
    ...
    version=find_version("jobtasticmixins", "__init__.py"),
    url='https://github.com/abbasovalex/JobtasticMixins',
    license='MIT',
    description="Provides ability calculate average time of tasks",
